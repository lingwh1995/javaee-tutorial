package org.bluebridge.section_04_socket.unit_02_nio;
...
/**
 * 阻塞方式实现网络通信-基于 NIO 的 Channel 理解阻塞通信模型（阻塞方式可以与单个客户端完成每一次通信，无法正常的与多个客户端完成每一次通信）
 *
 * NIO 模型网络通信 Server 端 - V1.0 服务端接收多个客户端单条消息发送和接收需求
 *
 * 测试方法
 ...
 */
@Slf4j
public class Case_01_BlockingSocketChannelServer {
