package org.bluebridge.section_05_selector.section_01_tcp.unit_03_tcp;
 ...
 *   Set<SelectionKey> keys(): 获取当前 channel 注册在 Selector 上所有的 key
 ...
 *      Object attach(Object ob)/Object attachment():    可以将一个对象附加到选择键上，便于在处理事件时访问相关数据
 *        或者在注册时也可以直接添加   SelectionKey key = channel.register(selector, SelectionKey.OP_READ, theObject);
 *      boolean isAcceptable():   服务端连接事件是否就绪
