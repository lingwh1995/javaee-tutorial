...
public class EventProducer {
    ...
    /**
     * 发送消息：使用 ProducerRecord 对象封装消息
     */
    public void produceByProducerRecord() {
        // 存放一些信息，消费者收到该消息后，可以拿到 Headers 中存放的信息
    ...
    /**
     * 发送消息：使用 sendDefault 方法参数封装消息
     *      注意：需要在 yml 文件中配置默认主题 spring.template.default-topic
     */
