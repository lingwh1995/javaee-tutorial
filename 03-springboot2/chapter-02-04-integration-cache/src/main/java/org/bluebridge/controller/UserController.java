...
public class UserController {
    ...
    /**
     * 测试 @CachePut : 同步更新缓存的功能(更新数据库中的数据，并且根据id更新缓存中的数据)
     *
     * 测试步骤
     ...
     *
     * 先访问: http://localhost:8080/caching_id/001   打印sql
     * 再访问: http://localhost:8080/caching_username/zhangsan  直接从缓存中获取，不会打印sql
     *
     * 测试 @Caching() 配置复杂缓存策略 + @CachePut 高级用法: 根据id获取 User 对象部分
     *
     * 注意
     ...
     * 2. 使用cachemanager从缓存中获取数据: http://localhost:8080/cachemanager
     *
     * @return
     */
    @ResponseBody
